...
<button class="btn text-white" data-toggle="modal" data-target="#exampleModal" style="background:#001f3f; margin-top: 0px; float: left;">+ Tambah Data Siswa</button>

<!-- link untuk ke halaman import.php-->
<a href="import.php" class="btn btn-secondary" style="float: left; margin-top: 40px; margin-left: -177px;">import data siswa dengan excel (.xls)</a>
...
?>
	...
	<tr>
		...
		<td><a href="crud_siswa/edit.php?id=<?php echo($id); ?>"><button class="btn btn-info text-white" style="width: 45%;">EDIT</button></a>
			<a href="crud_siswa/hapus.php?id=<?php echo($id); ?>"><button class="btn btn-danger text-white" style="width: 47%;">HAPUS</button></a></td>
...
<?php 
// scrip yang dijalankan apabila tombol simpan ditekan
...
$tambah="INSERT into siswa (nama,jenis_kelamin,kelas)values('$a','$b','$c')";
...
?>
<!-- form untuk tambah data siswa, form ini menggunakan modal -->
